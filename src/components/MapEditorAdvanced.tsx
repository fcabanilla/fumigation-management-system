...
const EditButton = styled.button<{ variant?: 'danger' | 'success' | 'warning' }>`
  background: ${props => 
    props.variant === 'danger' ? '#dc3545' :
    props.variant === 'success' ? '#28a745' :
    props.variant === 'warning' ? '#ffc107' : '#007bff'};
...
const extractVerticesFromGeometry = (geometry: GeoJSONFeature | null): EditableVertex[] => {
...
const verticesToGeoJSON = (vertices: EditableVertex[]): GeoJSONFeature | null => {
...
const EditableVertexComponent: React.FC<{
  ...
  onVertexMove: (vertex: EditableVertex, newLat: number, newLng: number) => void;
    ...
    <Container height={height}>
      ...
      <Header>
        ...
        <ToolsContainer>
          ...
          {drawingState.currentTool === DRAWING_TOOLS.EDIT && editingState.isEditing && (
            <EditControls>
